...
const featureSectionData = {
    ...
    featureTabTitle2:"Best features<br className='d-none d-xs-block' />for your project<br className='d-none d-xs-block' /> management.",
    featureTabTitle3:"Best features<br className='d-none d-xs-block' />for your project<br className='d-none d-xs-block' /> management.",
    tabWidget1: [
        {
