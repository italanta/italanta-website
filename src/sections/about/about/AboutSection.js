      ...
      <Col col="12" className="col-xxl-5 offset-xxl-1 col-lg-5 col-md-8 col-xs-10">
        <About.Content mt="40px" mtLG="0" mb="50px" mbLG="0" mlLG="30px">
          ...
          <About.ButtonGroup mt="25px">
            <About.Button className="btn-primary btn-1" as={Link} to="/for-devs">For devs</About.Button>
            <About.Button className="btn-electric-violet-2 btn-2"  as={Link} to="/contact">Start Building</About.Button>
          </About.ButtonGroup>
        </About.Content>
      </Col>
    </Row>
