  ...
  return (
    <Feature backgroundColor="#fff">
      <Container>
        {/* Section Title */}
        <Row>
          <Col className="col-xl-8 col-lg-10"></Col>
        </Row>
        <Row></Row>
        {/*/ .Section Title */}
        {/* Feature Content */}
            ...
            <Col>
              ...
              <Feature.Box>
                <Feature.Text mrLG="30px">
                  ...
                  Develop and Deploy talent in the Information Technology
                  Domain. We have local presence in the EU and US where we work
                  with clients to address tech needs.
                </Feature.Text>
              </Feature.Box>
              <Feature.Box>
                <Feature.Text mrLG="30px">
                  ...
                  on-the-job training. Internally and with international
                  clients.
                </Feature.Text>
              </Feature.Box>
            </Col>
